...
begin
  ...
  begin
    ...
    sUsuario := InputBox('Segurança','INFORME O NOME DO USUÁRIO: ','');
    ...
    begin
      ...
      sSenha := InputBox('Segurança','INFORME A SENHA DO USUARIO: ','');
    ...
    begin
      ...
      //excluir informações de entrega no banco do zeus
...
begin
  ...
  begin
    ...
    begin
      ...
      lblMsg.Caption := dmDBEXMaster.sNomeUsuario + ' em pedidos com frete com pagamento a prazo é preciso informar o cliente';
      edtCliente.SetFocus;
      exit;
...
begin
  ...
  begin
    ...
    //verifica se o usuario digitou o valor menor que o preço de custo e se o sistema não permite
  ...
  case key of
    ...
    VK_F7:begin //visualiza cadastro de produtos
            ...
            begin
              ...
              begin
                ...
                sSenha := InputBox('Segurança','INFORME A SENHA: ','');
    ...
    VK_F8:begin //autoriza desconto
            ...
            begin
              ...
              sUsuario_autorizou := InputBox('Segurança','INFORME O NOME DO USUÁRIO: ','');
...
begin
  ...
  try
    ...
    begin
      ...
      dmMSProcedure.fdspCre.Params[4].Value     := 0;                                       {situação}
      ...
      dmMSProcedure.fdspCre.Params[7].Value     := 0;                                       {ver o que é tipo}
      ...
      dmMSProcedure.fdspCre.Params[15].Value    := 'LANCAMENTO EFETUADO POR PEDIDO DE VENDA Nº ' + IntToStr(dmMProvider.cdsPedidoZeusPEDIDO.Value);
      ...
      dmMSProcedure.fdspCre.Params[23].Value    := 0;                                       {tipo cobrança}
      ...
      dmMSProcedure.fdspCre.Params[30].Value    := 0;                                       {redução}
      dmMSProcedure.fdspCre.Params[31].Value    := 0;                                       {valor comissão}
      dmMSProcedure.fdspCre.Params[32].Value    := null;                                    {nf saida}
      dmMSProcedure.fdspCre.Params[33].Value    := null;                                    {observações}
      dmMSProcedure.fdspCre.Params[34].Value    := 0;                                       {valor chq devolvido}
      dmMSProcedure.fdspCre.Params[35].Value    := 0;                                       {sequencial}
      dmMSProcedure.fdspCre.Params[36].Value    := 0;                                       {outros débitos}
...
begin
  ...
  begin
    ...
    if dmMProvider.cdsUsuarios.IsEmpty then
      lblMsg.Caption := 'Usuário não habilitado no sistema! = ' + pUsuario
      ...
      lblMsg.Caption := 'Usuário não possui privilégio para esta operação!'
