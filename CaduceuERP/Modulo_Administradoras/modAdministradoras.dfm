object frmAdministradoras: TfrmAdministradoras
  ...
  object pgcAdministradoras: TPageControl
    Left = 8
    Top = 77
    Width = 649
    Height = 364
    ...
    object tbsTabela: TTabSheet
      ...
      object grdTabela: TDBGrid
        ...
        Height = 336
        Align = alClient
        DataSource = dmMSource.dtsAdministradoras
    ...
    object tbsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object lblPazo: TLabel
          Left = 62
          Top = 160
          Width = 88
          Height = 13
          Caption = 'Prazo para cr'#233'dito'
        end
        object lblDiasCredito: TLabel
          Left = 248
          Top = 160
          Width = 19
          Height = 13
        ...
        object lblCodigoBandeira: TLabel
          Left = 62
          Top = 113
          Width = 77
          Height = 13
          Caption = 'COD.BANDEIRA'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clRed
          Font.Height = -11
          Font.Name = 'Tahoma'
        ...
        object grpContaCredito: TGroupBox
          Left = 62
          Top = 184
          Width = 519
          Height = 147
          Caption = 'Informa'#231#245'es da conta para cr'#233'dito'
          TabOrder = 7
          ...
          object cboConta: TDBLookupComboBox
            ...
            ListFieldIndex = 1
            ListSource = dmMSource.dtsContaCorente
            TabOrder = 1
            OnExit = edtContaExit
            OnKeyPress = edtConteudoPesquisaKeyPress
          end
        end
        object edtCodigoRede: TDBEdit
          Left = 157
          Top = 86
          Width = 81
          Height = 21
        ...
        object edtCodigoBandeira: TDBEdit
          Left = 157
          Top = 110
          Width = 81
          Height = 21
          DataField = 'COD_BANDEIRA'
          DataSource = dmMSource.dtsAdministradoras
          TabOrder = 4
          OnEnter = edtNomeEnter
          OnExit = edtNomeEnter
