...
type
  TfrmAdministradoras = class(TForm)
    ...
    actSalvar: TAction;
    actExcluir: TAction;
    lblCodigoRede: TLabel;
    edtCodigoRede: TDBEdit;
    lblCodigoBandeira: TLabel;
    edtCodigoBandeira: TDBEdit;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        dmMSProcedure.fdspAdministradoras.Params[12].Value := dmMProvider.cdsAdministradorasCOD_REDE.Value;
        dmMSProcedure.fdspAdministradoras.Params[13].Value := dmMProvider.cdsAdministradorasCOD_BANDEIRA.Value;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if dmMProvider.cdsAdministradorasBANCO.Value <= 0 then
            dmMSProcedure.fdspAdministradoras.Params[3].Value:= null
          else
            dmMSProcedure.fdspAdministradoras.Params[3].Value:= dmMProvider.cdsAdministradorasBANCO.Value;
          ...
          if dmMSProcedure.fdspAdministradoras.Params[14].Value > 0 then
