...
begin
  ...
  if ACBrCEP1.Enderecos.Count < 1 then
    lblMsg.Caption :=  dmDBEXMaster.sNomeUsuario + ', nenhum Endereço encontrado!'
  else
  begin
     ...
     begin
       ...
       begin
          ...
          begin
            ...
            lblMsg.Caption := dmDBEXMaster.sNomeUsuario + ', verifique o código do IBGE no cadsatro da cidade: ' + Municipio + ', e tente novamente';
            Application.ProcessMessages
  ...
  begin
    ...
    try
      ...
      begin
        ...
        lblMsg.Caption := dmDBEXMaster.sNomeUsuario + ', consulta do CEP não realizada. ' + Tratar_Erro_Conexao(E);
        Application.ProcessMessages;
