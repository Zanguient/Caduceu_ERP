object frmMva: TfrmMva
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'MVA - Margem de valor agregado'
  ClientHeight = 271
  ClientWidth = 476
  Color = clBtnFace
  ...
  object grpEstado: TGroupBox
    ...
    TabOrder = 0
    object cboEstado: TDBLookupComboBox
      Left = 16
      Top = 19
      Width = 66
      Height = 21
      ...
      TabOrder = 0
      OnCloseUp = cboEstadoCloseUp
      OnExit = cboEstadoExit
      OnKeyPress = cboEstadoKeyPress
    end
  end
  object grpMVA: TGroupBox
    Left = 201
    Top = 2
    Width = 88
    Height = 49
    Caption = 'Informe a MVA'
    TabOrder = 2
    object edtMVA: TDBEdit
      ...
      Width = 69
      Height = 21
      DataField = 'MARGEM_MVA'
      TabOrder = 0
      OnEnter = edtICMS_InternoEnter
      OnExit = edtMVAExit
      OnKeyDown = edtICMS_InternoKeyDown
      OnKeyPress = edtICMS_InternoKeyPress
    end
  end
  object grpIcms_IE: TGroupBox
    Left = 289
    Top = 2
    Width = 120
    Height = 49
    ...
    object edtICMS_IE: TDBEdit
      ...
      TabOrder = 0
      OnEnter = edtICMS_InternoEnter
      OnExit = edtICMS_IEExit
      OnKeyDown = edtICMS_InternoKeyDown
      OnKeyPress = edtICMS_InternoKeyPress
    end
  end
  object grpICMS_Interno: TGroupBox
    Left = 113
    Top = 2
    Width = 88
    Height = 49
    ...
    TabOrder = 1
    object edtICMS_Interno: TDBEdit
      Left = 9
      Top = 19
      Width = 69
      Height = 21
