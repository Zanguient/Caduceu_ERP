object frmItemPecaPadrao: TfrmItemPecaPadrao
  Left = 0
  Top = 0
  ActiveControl = edtConteudoPesquisa
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Inclus'#227'o de pe'#231'as padr'#227'o'
  ClientHeight = 360
  ClientWidth = 967
  Color = clBtnFace
  ...
  object rdgOpcoesPesquisa: TRadioGroup
    Left = 8
    Top = 8
    Width = 490
    Height = 49
    Caption = 'Op'#231#245'es para pesquisa'
    Columns = 3
    ItemIndex = 2
    Items.Strings = (
      'C'#243'digo'
      ...
      'Descri'#231#227'o')
    TabOrder = 0
    OnClick = rdgOpcoesPesquisaClick
  end
  ...
  object grpInformacoesItem: TGroupBox
    Left = 8
    Top = 63
    Width = 885
    Height = 154
    Caption = 'Informa'#231#245'es do item'
    TabOrder = 2
    object grdPecas: TDBGrid
      ...
      TitleFont.Style = []
      OnDrawColumnCell = grdPecasDrawColumnCell
      OnDblClick = grdPecasDblClick
      OnKeyPress = grdPecasKeyPress
      Columns = <
        item
          Expanded = False
          FieldName = 'PRODUTO'
  ...
  object grpInformacoesGerais: TGroupBox
    ...
    object grpQuantidade: TGroupBox
      ...
      object edtQuantidade: TJvValidateEdit
        ...
        TabOrder = 0
        OnEnter = edtConteudoPesquisaEnter
        OnExit = edtConteudoPesquisaEnter
        OnKeyDown = edtConteudoPesquisaKeyDown
    ...
    object grpDataUtilizacao: TGroupBox
      Left = 210
      Top = 16
      Width = 114
      Height = 43
      Caption = 'Data de utiliza'#231#227'o'
      TabOrder = 2
      object dtpDataUtilizacao: TDateTimePicker
        Left = 8
        Top = 16
        Width = 98
        Height = 21
        Date = 41989.355031180550000000
        Time = 41989.355031180550000000
        TabOrder = 0
        OnKeyPress = edtConteudoPesquisaKeyPress
      end
    end
  ...
  object rdgTipoPeca: TRadioGroup
    Left = 671
    Top = 223
    Width = 222
    Height = 74
