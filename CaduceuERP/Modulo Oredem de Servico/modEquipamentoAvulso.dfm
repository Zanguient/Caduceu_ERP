object frmModEquipamentoAvulso: TfrmModEquipamentoAvulso
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de equipamento avulso'
  ClientHeight = 211
  ClientWidth = 539
  Color = clBtnFace
  ...
  object grpInformacaoEquipamento: TGroupBox
    Left = 8
    Top = 8
    Width = 464
    Height = 153
    ...
    object edtAparelho: TEdit
      ...
      MaxLength = 100
      TabOrder = 0
      TextHint = 'CAMPO OBRIGAT'#211'RIO'
      OnEnter = edtAparelhoEnter
      OnExit = edtAparelhoEnter
      OnKeyDown = edtAparelhoKeyDown
      OnKeyPress = edtAparelhoKeyPress
    end
