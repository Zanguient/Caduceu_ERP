  ...
  begin
    ...
    begin
      ...
      begin
        ...
        dmMProvider.cdsParcelasOSDOCUMENTO.Value              := '';
        dmMProvider.cdsParcelasOSPARCELAS_ORDEM_SERVICO.Value := 1;
...
procedure TfrmFormasPagamentoOS.imgConfirmarClick(Sender: TObject);
begin
...
procedure TfrmFormasPagamentoOS.imgSairClick(Sender: TObject);
begin
...
begin
  ...
  try
    ...
    dmMSProcedure.fdspParcelas_OrdemServico.Params[2].Value       := dmMProvider.cdsOrdemServicoORDEM_DE_SERVICO.Value;
    dmMSProcedure.fdspParcelas_OrdemServico.Params[3].Value       := dmMProvider.cdsParcelasOSVENCIMENTO.Value;
    dmMSProcedure.fdspParcelas_OrdemServico.Params[4].Value       := dmMProvider.cdsParcelasOSVALOR.Value;
    dmMSProcedure.fdspParcelas_OrdemServico.ExecProc;
