...
type
  ...
  TfrmPesquisaKit = class(TForm)
    ...
    procedure grdProducaoDblClick(Sender: TObject);
    procedure grdProducaoKeyPress(Sender: TObject; var Key: Char);
  private
...
procedure TfrmPesquisaKit.grdProducaoDblClick(Sender: TObject);
begin
...
procedure TfrmPesquisaKit.grdProducaoKeyPress(Sender: TObject; var Key: Char);
begin

  if key = #13 then
    grdProducaoDblClick(self);
