object frmDeslocamentoOS: TfrmDeslocamentoOS
  Left = 0
  Top = 0
  ...
  object imgGerarRelatorioConsulta: TImage
    Left = 1068
    Top = 281
    Width = 43
    Height = 40
    ...
    Picture.Data = {
      ...
      
      6EC9F4803F99DBD6464F5568C20000000049454E44AE426082}
    ShowHint = True
    OnClick = imgGerarRelatorioConsultaClick
  end
  object grdTabela: TDBGrid
    ...
    Height = 375
    Hint = 
      'Duplo clique altera , <DELETE - F5> exclui lan'#231'amento selecionad' +
      'o'
    DataSource = dmMSource.dtsDeslocamentoOS
    ...
    OnDblClick = actManutencaoExecute
    OnKeyDown = grdTabelaKeyDown
    Columns = <
      item
        Expanded = False
        FieldName = 'DATA_CADASTRO'
        Title.Alignment = taCenter
        Title.Caption = 'Data sa'#237'da OR'
        Visible = True
      end
      item
        Expanded = False
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hora sa'#237'da OR'
        Visible = True
      end
      item
        Expanded = False
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hora chegada DEST'
        Visible = True
      end
      item
        Expanded = False
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hora sa'#237'da DEST'
        Visible = True
      end
      item
        Expanded = False
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Km sa'#237'da DEST'
        Width = 100
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hora regresso OR'
        Visible = True
      end
      item
        Expanded = False
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'R$ Alimenta'#231#227'o'
        Width = 82
        Visible = True
      end
      item
  ...
  object pnlTitulo: TPanel
    ...
    Height = 28
    Align = alTop
    Caption = 'Registro de Deslocamentos'
    Color = clWhite
  ...
  object ActionList1: TActionList
    ...
    object actManutencao: TAction
      Caption = 'actManutencao'
      OnExecute = actManutencaoExecute
    end
    object actExcluirDeslocamentoOS: TAction
      Caption = 'actExcluirDeslocamentoOS'
      OnExecute = actExcluirDeslocamentoOSExecute
    end
  end
end
