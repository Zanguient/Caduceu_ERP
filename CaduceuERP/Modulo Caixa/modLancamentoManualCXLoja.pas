...
begin
  ...
  if (Length(Trim(cboRetirante.KeyValue)) > 0) and (rdgTipoLançamento.ItemIndex = 0) then
  begin
...
begin
  ...
  else if (Length(Trim(cboAutorizador.KeyValue)) <= 0) and (rdgTipoLançamento.ItemIndex = 0) then
  begin
