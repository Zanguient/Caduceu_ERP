object frmFornecedor: TfrmFornecedor
  ...
  object pgcFornecedor: TPageControl
    Left = 8
    Top = 86
    Width = 796
    Height = 540
    ...
    object tbsTabela: TTabSheet
      ...
      object grdTabela: TDBGrid
        ...
        Height = 512
        Align = alClient
        DataSource = dmMSource.dtsFornecedor
    ...
    object tbsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object rdgTipoEmpresa: TDBRadioGroup
          Left = 583
          Top = 63
          Width = 182
          Height = 38
          ...
          Values.Strings = (
            '0'
            '1')
          OnClick = rdgTipoEmpresaClick
        end
        object rdgAtividade: TDBRadioGroup
          Left = 583
          Top = 101
          Width = 182
          Height = 68
          ...
          Values.Strings = (
            ...
            '3'
            '4')
          OnClick = rdgAtividadeClick
        end
        object chkAtacadistaRegEspecial: TDBCheckBox
          Left = 583
          Top = 172
          Width = 143
          Height = 17
          Caption = 'Atacadista reg. especial'
          DataField = 'ATACADISTAREGIMEESPECIAL'
          DataSource = dmMSource.dtsFornecedor
          TabOrder = 26
          ValueChecked = '1'
          ValueUnchecked = '0'
        ...
        object chkOptanteSimplesNacional: TDBCheckBox
          Left = 583
          Top = 193
          Width = 143
          Height = 17
        ...
        object cboPaises: TDBLookupComboBox
          Left = 95
          Top = 39
          Width = 477
          Height = 21
        ...
        object cboNomeCidade: TDBLookupComboBox
          Left = 298
          Top = 229
          Width = 274
          Height = 21
          ...
          KeyField = 'CIDADE'
          ListField = 'NOME'
          ListSource = dmMSource.dtsCidades
          TabOrder = 13
          OnKeyPress = edtConteudoPesquisaKeyPress
        end
        object cboUF: TDBLookupComboBox
          Left = 95
          Top = 229
          Width = 148
          Height = 21
        ...
        object edtInsSUFRAMA: TDBEdit
          ...
          TabOrder = 7
          OnEnter = edtRazaoSocialEnter
          OnExit = edtInsSUFRAMAExit
          OnKeyDown = edtConteudoPesquisaKeyDown
          OnKeyPress = edtCNPJKeyPress
        end
      end
      object pcpInformacoes: TPageControl
        Left = 0
        Top = 378
        Width = 788
        Height = 134
        ActivePage = tbsUltimaNFEntrada
        Align = alBottom
        TabOrder = 1
        object tbsUltimaNFEntrada: TTabSheet
          Caption = 'Ultima NF Entrada'
          object grdUltimaNFEntrada: TDBGrid
            Left = 0
            Top = 0
            Width = 780
            Height = 106
            ...
            TitleFont.Name = 'Tahoma'
            TitleFont.Style = []
            OnDrawColumnCell = grdUltimaNFEntradaDrawColumnCell
            Columns = <
              item
                Expanded = False
        ...
        object tbsUltimaOrdemCompra: TTabSheet
          Caption = #218'ltima ordem Compra'
          ImageIndex = 1
          object grdUltimaordemCompra: TDBGrid
            Left = 0
            Top = 0
            Width = 780
            Height = 106
            ...
            TitleFont.Name = 'Tahoma'
            TitleFont.Style = []
            OnDrawColumnCell = grdUltimaordemCompraDrawColumnCell
            Columns = <
              item
                Expanded = False
                FieldName = 'ORDEMDECOMPRA'
                Title.Alignment = taCenter
                Title.Caption = 'N'#186' O.COMPRA'
                Width = 89
                Visible = True
              end
              item
              ...
              item
                ...
                Title.Alignment = taCenter
                Title.Caption = 'PREV. FATURAMENTO'
                Width = 120
                Visible = True
              end
              item
