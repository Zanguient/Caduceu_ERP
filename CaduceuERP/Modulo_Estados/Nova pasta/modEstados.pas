...
type
  ...
  TfrmEstados = class(TForm)
    ...
    chkEstadoBrasileiro: TDBCheckBox;
    lblCodigoPais: TLabel;
    edtCodigoPais: TDBEdit;
    lblCodigoSINIEF: TLabel;
    edtCodigoSINIEF: TDBEdit;
    rdgRegiaoGeografica: TDBRadioGroup;
    DBRadioGroup1: TDBRadioGroup;
    Label1: TLabel;
    edtMascaraInscEst: TDBEdit;
    chkUtilizaAtivEstadual: TDBCheckBox;
    edtMascaraAtivEst: TDBEdit;
    lblMascaraAtivEst: TLabel;
    chkConvenioSimplesFederal: TDBCheckBox;
    edtAliquota_Simples_Federal: TDBEdit;
    lblAliquotaSimplesFederal: TLabel;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          LimparMSG_ERRO(lblMsg, nil);
          if dmMProvider.cdsEstados.State in [dsInsert] then
          begin
...
begin
  ...
  else if dmMProvider.cdsEstadosCODIGO_PAIS.Value < 0 then
  begin
