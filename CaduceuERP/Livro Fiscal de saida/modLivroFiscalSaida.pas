...
begin
  ...
  try
    ...
    begin
      ...
      BMP_PNG('proc_ManTabLivroSaida.bmp',ExtractFilePath(ParamStr(0)),ExtractFilePath(ParamStr(0)),True);
...
begin
  ...
  on E: Exception do
    begin
      ...
      BMP_PNG('TotalizaAliquotas.bmp',ExtractFilePath(ParamStr(0)),ExtractFilePath(ParamStr(0)),True);
...
begin
  ...
  on E: Exception do
    begin
      ...
      BMP_PNG('TotalizaLivro.bmp',ExtractFilePath(ParamStr(0)),ExtractFilePath(ParamStr(0)),True);
