...
//          dmMSProcedure.fdspOrdemServico.Params[40].Value := dmShoficina.fdqOSOS_GARANTIDOR.Value;
    ...
    LABEL6.Caption := 'foram incluídas: ' + IntToStr(iContador) + ' OS';
    Application.ProcessMessages;
...
begin
  ...
  try
    ...
    LABEL1.Caption := 'foram incluídos: ' + IntToStr(iContador) + ' clientes';
    Application.ProcessMessages;
...
begin
  ...
  try
    ...
    LABEL2.Caption := 'foram incluídos: ' + IntToStr(iContador) + ' equipamentos';
    Application.ProcessMessages;
...
begin
  ...
  try
    ...
    begin
      ...
      if dmShoficina.fdqSituacoesSHETAPA3_PG.Value then//condicçaõ de fechamento
    ...
    LABEL3.Caption := 'foram incluídos: ' + IntToStr(iContador) + ' situações';
    Application.ProcessMessages;
