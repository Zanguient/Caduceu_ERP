...
type
  TfrmApuracaoICMS = class(TForm)
    ...
    Button2: TButton;
    Button3: TButton;
    sqqTotalizaVContabilE: TFDQuery;
    sqqTotalizaBCalculoE: TFDQuery;
    sqqTotalizaCredito_E: TFDQuery;
    sqqTotalizaIsentasNT_E: TFDQuery;
    sqqTotalizaOutras_E: TFDQuery;
    sqqTotalVLContEstadual_E: TFDQuery;
    sqqTotalBCalculoEstadual_E: TFDQuery;
    sqqTotalICreditadoEstadual_E: TFDQuery;
    sqqTotalIsentasNTEstadual_E: TFDQuery;
    sqqTotalOutrasEstadual_E: TFDQuery;
    sqqTotalizaVContabil_IE: TFDQuery;
    sqqTotalizaBCalculo_IE: TFDQuery;
    sqqTotalICreditadoEstadual_IE: TFDQuery;
    sqqTotalIsentasNTEstadual_IE: TFDQuery;
    sqqTotalOutrasEstadual_IE: TFDQuery;
    sqqTotalizaVContabilS: TFDQuery;
    sqqTotalizaBCalculoS: TFDQuery;
    sqqTotalizaDebito_S: TFDQuery;
    sqqTotalizaIsentasNT_S: TFDQuery;
    sqqTotalizaOutras_S: TFDQuery;
    sqqTotalVLContEstadual_S: TFDQuery;
    sqqTotalBCalculoEstadual_S: TFDQuery;
    sqqTotalIDebitadoEstadual_S: TFDQuery;
    sqqTotalIsentasNTEstadual_S: TFDQuery;
    sqqTotalOutrasEstadual_S: TFDQuery;
    sqqTotalizaVContabil_IE_S: TFDQuery;
    sqqTotalizaBCalculo_IE_S: TFDQuery;
    sqqTotalIDebitadoEstadual_IE_S: TFDQuery;
    sqqTotalIsentasNTEstadual_IE_S: TFDQuery;
    sqqTotalOutrasEstadual_IE_S: TFDQuery;
