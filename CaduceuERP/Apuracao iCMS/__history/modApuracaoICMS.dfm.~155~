object frmApuracaoICMS: TfrmApuracaoICMS
  ...
  object sqqSelecionaPeriodo: TFDQuery
  ...
  object sqqTotalizaVContabilE: TFDQuery
  ...
  object sqqTotalizaBCalculoE: TFDQuery

    Params = <>
    Left = 64
    Top = 200
  end
  object sqqTotalizaCredito_E: TFDQuery

    Params = <>
    Left = 64
    Top = 256
  end
  object sqqTotalizaIsentasNT_E: TFDQuery

    Params = <>
    Left = 64
    Top = 298
  end
  object sqqTotalizaOutras_E: TFDQuery

    Params = <>
    Left = 64
    Top = 344
  end
  object sqqTotalVLContEstadual_E: TFDQuery

    Params = <>
    Left = 209
    Top = 151
  end
  object sqqTotalBCalculoEstadual_E: TFDQuery

    Params = <>
    Left = 192
    Top = 208
  end
  object sqqTotalICreditadoEstadual_E: TFDQuery

    Params = <>
    Left = 194
    Top = 257
  end
  object sqqTotalIsentasNTEstadual_E: TFDQuery

    Params = <>
    Left = 194
    Top = 302
  end
  object sqqTotalOutrasEstadual_E: TFDQuery

    Params = <>
    Left = 194
    Top = 345
  end
  object sqqTotalizaVContabil_IE: TFDQuery
  ...
  object sqqTotalizaBCalculo_IE: TFDQuery

    Params = <>
    Left = 328
    Top = 200
  end
  object sqqTotalICreditadoEstadual_IE: TFDQuery

    Params = <>
    Left = 328
    Top = 245
  end
  object sqqTotalIsentasNTEstadual_IE: TFDQuery

    Params = <>
    Left = 328
    Top = 290
  end
  object sqqTotalOutrasEstadual_IE: TFDQuery

    Params = <>
    Left = 330
    Top = 337
  end
  object sqqTotalizaVContabilS: TFDQuery
  ...
  object sqqTotalizaBCalculoS: TFDQuery

    Params = <>
    Left = 64
    Top = 484
  end
  object sqqTotalizaDebito_S: TFDQuery

    Params = <>
    Left = 64
    Top = 524
  end
  object sqqTotalizaIsentasNT_S: TFDQuery

    Params = <>
    Left = 64
    Top = 568
  end
  object sqqTotalizaOutras_S: TFDQuery

    Params = <>
    Left = 64
    Top = 609
  end
  object sqqTotalVLContEstadual_S: TFDQuery

    Params = <>
    Left = 193
    Top = 438
  end
  object sqqTotalBCalculoEstadual_S: TFDQuery

    Params = <>
    Left = 192
    Top = 480
  end
  object sqqTotalIDebitadoEstadual_S: TFDQuery

    Params = <>
    Left = 194
    Top = 521
  end
  object sqqTotalIsentasNTEstadual_S: TFDQuery

    Params = <>
    Left = 194
    Top = 566
  end
  object sqqTotalOutrasEstadual_S: TFDQuery

    Params = <>
    Left = 194
    Top = 609
  end
  object sqqTotalizaVContabil_IE_S: TFDQuery
  ...
  object sqqTotalizaBCalculo_IE_S: TFDQuery

    Params = <>
    Left = 354
    Top = 480
  end
  object sqqTotalIDebitadoEstadual_IE_S: TFDQuery

    Params = <>
    Left = 355
    Top = 522
  end
  object sqqTotalIsentasNTEstadual_IE_S: TFDQuery

    Params = <>
    Left = 354
    Top = 565
  end
  object sqqTotalOutrasEstadual_IE_S: TFDQuery
