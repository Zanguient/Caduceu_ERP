object frmApuracaoICMS: TfrmApuracaoICMS
  ...
  object fdqTotalizaBCalculoE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 200
  end
  object fdqTotalizaCredito_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 256
  end
  object fdqTotalizaIsentasNT_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 298
  end
  object fdqTotalizaOutras_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 344
  end
  object fdqTotalBCalculoEstadual_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 192
    Top = 208
  end
  object fdqTotalICreditadoEstadual_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 194
    Top = 257
  end
  object fdqTotalIsentasNTEstadual_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 194
    Top = 302
  end
  object fdqTotalOutrasEstadual_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 194
    Top = 345
  end
  object fdqTotalizaVContabil_IE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    SQL.Strings = (
  ...
  object fdqTotalizaBCalculo_IE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 328
    Top = 200
  end
  object fdqTotalICreditadoEstadual_IE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 328
    Top = 245
  end
  object fdqTotalIsentasNTEstadual_IE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 328
    Top = 290
  end
  object fdqTotalOutrasEstadual_IE: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 330
    Top = 337
  end
  object fdqTotalizaVContabilS: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    SQL.Strings = (
  ...
  object fdqTotalizaBCalculoS: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 484
  end
  object fdqTotalizaDebito_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 64
    Top = 524
  end
  object fdqTotalizaIsentasNT_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 488
    Top = 304
  end
  object fdqTotalizaOutras_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 688
    Top = 297
  end
  object fdqTotalVLContEstadual_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 193
    Top = 438
  end
  object fdqTotalBCalculoEstadual_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 192
    Top = 480
  end
  object fdqTotalIDebitadoEstadual_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 194
    Top = 521
  end
  object fdqTotalIsentasNTEstadual_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 650
    Top = 502
  end
  object fdqTotalOutrasEstadual_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 650
    Top = 321
  end
  object fdqTotalizaVContabil_IE_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    SQL.Strings = (
  ...
  object fdqTotalizaBCalculo_IE_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 354
    Top = 480
  end
  object fdqTotalIDebitadoEstadual_IE_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 355
    Top = 522
  end
  object fdqTotalIsentasNTEstadual_IE_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 570
    Top = 429
  end
  object fdqTotalOutrasEstadual_IE_S: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 658
    Top = 425
  end
  ...
  object fdqTotalVLContEstadual_E: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    Left = 209
    Top = 151
  end
