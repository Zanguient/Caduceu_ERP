object frmFichaTecnica: TfrmFichaTecnica
  ...
  object pgcProducao: TPageControl
    ...
    object tbsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object edtRendimento: TDBEdit
          ...
          TabOrder = 2
          OnEnter = edtProdutoEnter
          OnExit = edtRendimentoExit
          OnKeyDown = edtConteudoPesquisaKeyDown
          OnKeyPress = edtRendimentoKeyPress
        end
        ...
        object grpComposicao: TGroupBox
          Left = 1
          Top = 81
          Width = 886
          Height = 226
          Caption = 'Composi'#231#227'o / Insumos'
          TabOrder = 3
          object grdItemProducao: TDBGrid
            Left = 2
            Top = 72
            Width = 882
            Height = 152
            Hint = 
              'Duplo clique no item, seleciona-o para altera'#231#227'o , <DELETE> Remo' +
              've item'
            Align = alBottom
            ...
            TitleFont.Name = 'Tahoma'
            TitleFont.Style = []
            OnDrawColumnCell = grdItemProducaoDrawColumnCell
            OnDblClick = grdItemProducaoDblClick
            OnKeyDown = grdItemProducaoKeyDown
            Columns = <
              item
                Expanded = False
                FieldName = 'PRODUTO'
          ...
          object grpCodigoProduto: TGroupBox
            Left = 8
            Top = 16
            Width = 445
            Height = 44
            ...
            object imgPesqItem: TImage
              ...
              ShowHint = True
              Stretch = True
              OnClick = imgPesqItemClick
            end
            object edtItemProduto: TJvValidateEdit
              Left = 2
              Top = 16
              Width = 84
              Height = 21
          ...
          object grpPercPerda: TGroupBox
            ...
            Caption = '(%)Perda'
            TabOrder = 2
            object edtPercPerda: TJvValidateEdit
              Left = 4
              Top = 16
              Width = 49
              Height = 21
        ...
        object grpInformacao: TGroupBox
          ...
          object memInformacao: TMemo
            ...
            Font.Style = [fsBold]
            Lines.Strings = (
              '- Itens a ser produzido'
              '  Apenas itens clasificados no cadastro  como tipo item = 3 e 4'
              ''
              '-Itens para Composi'#231#227'o/Insumos'
              
                ' Apenas itens clasificados no cadastro como tipo item = 0, 1, 2,' +
                ' 3, 4, 5 ou 10')
            ParentFont = False
            TabOrder = 0
          end
    ...
    object tbsIngredientes: TTabSheet
      Caption = 'Ingredientes'
      ImageIndex = 2
      object grpIngrdientes: TGroupBox
        Left = 0
        Top = 0
        Width = 903
        Height = 420
        ...
        object pnlProduto: TPanel
          ...
          Enabled = False
          TabOrder = 0
          object edtDescricaoIngrediente: TDBEdit
            Left = 191
            Top = 4
            Width = 436
            Height = 21
          ...
          object edtUnidadeIngrediente: TDBEdit
            Left = 632
            Top = 4
            Width = 50
            Height = 21
          ...
          object edtProdutoIngrediente: TDBEdit
            Left = 100
            Top = 4
            Width = 85
            Height = 21
        ...
        object groIngredientes: TGroupBox
          Left = 2
          Top = 76
          Width = 899
          Height = 342
          ...
          Caption = 'Ingredientes'
          TabOrder = 1
          object edtIngrediente1: TDBEdit
            Left = 168
            Top = 54
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE1'
            DataSource = dmMSource.dtsProducao
            TabOrder = 0
          end
          object edtIngrediente2: TDBEdit
            Left = 168
            Top = 87
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE2'
            DataSource = dmMSource.dtsProducao
            TabOrder = 1
          end
          object edtIngrediente3: TDBEdit
            Left = 168
            Top = 120
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE3'
            DataSource = dmMSource.dtsProducao
            TabOrder = 2
          end
          object edtIngrediente4: TDBEdit
            Left = 168
            Top = 154
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE4'
            DataSource = dmMSource.dtsProducao
            TabOrder = 3
          end
          object edtIngrediente5: TDBEdit
            Left = 168
            Top = 187
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE5'
            DataSource = dmMSource.dtsProducao
            TabOrder = 4
          end
          object edtIngrediente6: TDBEdit
            Left = 168
            Top = 220
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE6'
            DataSource = dmMSource.dtsProducao
            TabOrder = 5
          end
          object edtIngrediente7: TDBEdit
            Left = 168
            Top = 254
            Width = 500
            Height = 21
            CharCase = ecUpperCase
            DataField = 'INGREDIENTE7'
            DataSource = dmMSource.dtsProducao
            TabOrder = 6
          end
        end
  ...
  object ActionList1: TActionList
    ...
    object actExcluirItemProducao: TAction
      Category = 'Window'
      Caption = 'actExcluirItemProducao'
      OnExecute = actExcluirItemProducaoExecute
    end
  end
end
