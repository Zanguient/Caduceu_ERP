object frmUnidadeMedida: TfrmUnidadeMedida
  ...
  object pgcUnidadeMedida: TPageControl
    Left = 8
    Top = 91
    Width = 553
    Height = 254
    ...
    object tbsTabela: TTabSheet
      ...
      object grdTabela: TDBGrid
        ...
        Cursor = crHandPoint
        Align = alClient
        DataSource = dmMSource.dtsUnidadeMedida
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
    ...
    object tdsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object chkPermiteVendaFracionada: TDBCheckBox
          Left = 89
          Top = 113
          Width = 145
          Height = 17
          Caption = 'permite venda fracionada'
          DataField = 'PERMITE_VENDA_FRACIONADA'
          DataSource = dmMSource.dtsUnidadeMedida
          TabOrder = 2
          ValueChecked = '1'
          ValueUnchecked = '0'
          OnClick = chkPermiteVendaFracionadaClick
        end
      end
    end
  end
