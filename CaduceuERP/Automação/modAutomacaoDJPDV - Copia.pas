...
//procedure ExportarCEST(sArquivo, sPath);
...
var
  ...
  sLinha, sLinhaTC, sBarras, sInfoTabBarras, sStatusProduto, sBarras_Temp, sDescricao, sArqLogBarras, sProduto: string;
...
//                        sBarras := Format('%-20.20s',[FormatFloat('00000000000000', StrToFloat(sBarras_Temp))]);
          ...
          1:begin
              ...
              repeat
                ...
                if dmMProvider.cdsSelProdExpPdvOP_UNIDADE.Value <> 'KG' then
                  sBarras   := Format('%-20.20s',[IntToStr(dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)])
//                  sBarras   := Format('%-20.20s',[FormatFloat('00000000000000', dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)])
                else
                  sBarras   := Format('%-20.20s',[IntToStr(dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)]);

                sLinha    := Format('%-20.20s',[IntToStr(dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)])
                            + sBarras
                            + Format('%-40.40s',[sDescricao])
                            + Format('%-20.20s',[dmMProvider.cdsSelProdExpPdvOP_COMPLEMENTO.Value])
                            + Format('%-4.4s',[dmMProvider.cdsSelProdExpPdvOP_UNIDADE.Value]);
                ...
                sInfoTabBarras := Retornar_Info_TabBarras(dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value);

                if LeituraLinhaArquivo(sInfoTabBarras,'|',2) = '0' then
                begin

                  if Length(LeituraLinhaArquivo(sInfoTabBarras,'|',1)) >= 8 then
                    sLinha := sLinha + Format('%20.20s',[FloatToStr(StrToFloat(Trim(LeituraLinhaArquivo(sInfoTabBarras,'|',1))))]) {sBarras}                                          //gtin contabil
                              + Format('%-20.20s',[' '])                                //ext IPI
                              + Format('%20.20s',[FloatToStr(StrToFloat(Trim(LeituraLinhaArquivo(sInfoTabBarras,'|',1))))]) {sBarras;} //gtin tributavel
                  else
                    sLinha := sLinha + Format('%-20.20s',[' '])                         //gtin contabil
                              + Format('%-20.20s',[' '])                                //ext IPI
                              + Format('%-20.20s',[' ']);                               //gtin tributavel
        ...
        repeat
          ...
          begin
            ...
            if dmMProvider.cdsSelCliExportacaoOP_LIMITE_CREDITO.Value < 0 then
              sLinha := sLinha + FormatFloat('000000000',dmMProvider.cdsSelCliExportacaoOP_LIMITE_CREDITO.Value)
            else
              sLinha := sLinha + FormatFloat('0000000000',dmMProvider.cdsSelCliExportacaoOP_LIMITE_CREDITO.Value);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          dmMDJPdv.fdqTerminal.SQL.Add('where codterminal = ' + IntToStr(dmMDJPdv.cdsCupomCODTERMINAL.Value));
          ...
          begin
            ...
            begin
              ...
              dmMProvider.fdmImpCupomSUB_TOTAL.Value        := (dmMDJPdv.cdsItemCupomQTD.Value * dmMDJPdv.cdsItemCupomPRECO_UNITARIO.Value) - (((dmMDJPdv.cdsItemCupomQTD.Value * dmMDJPdv.cdsItemCupomPRECO_UNITARIO.Value) * (cPercDesconto / 100)));
            ...
            begin
              ...
              dmMProvider.fdmImpCupomSUB_TOTAL.Value        := (dmMDJPdv.cdsItemCupomQTD.Value * dmMDJPdv.cdsItemCupomPRECO_UNITARIO.Value) + (((dmMDJPdv.cdsItemCupomQTD.Value * dmMDJPdv.cdsItemCupomPRECO_UNITARIO.Value) *(cPercAcrescimo / 100)));
              dmMProvider.fdmImpCupomVALOR_DESCONTO.Value   := 0;
            ...
            begin
              ...
              dmMProvider.fdmImpCupomSUB_TOTAL.Value        := (dmMDJPdv.cdsItemCupomQTD.Value * dmMDJPdv.cdsItemCupomPRECO_UNITARIO.Value);
              dmMProvider.fdmImpCupomVALOR_DESCONTO.Value   := 0;
              dmMProvider.fdmImpCupomVALOR_ACRESCIMO.Value  := 0;
...
//                      else
                  ...
                  sLinha := sBarras + sBarras + ' ' + '00000' + FormatFloat('0000000', dmMProvider.cdsSelProdExpPdvOP_QUANTIDADE.Value * 100);
...
//                            sBarras   := Format('%-20.20s',[FloatToStr(StrToFloat(Copy(sBarras_Temp, 1, 12)))]);
  //                            sBarras   := Format('%-20.20s',[FormatFloat('000000',StrToFloat(Copy(sBarras_Temp, 1, 12)))]);
//                            sProduto  := Format('%-20.20s',['2' + FormatFloat('00000',dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)]);
                            sProduto  := Format('%-20.20s',[FormatFloat('000000',dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)]);
...
//                            sBarras   := Format('%-20.20s',[FloatToStr(StrToFloat(Copy(sBarras_Temp, 1, 12)))]);
                            sBarras   := Format('%-20.20s',[FormatFloat('0000',StrToFloat(Copy(sBarras_Temp, 1, 12)))]);
//                            sBarras   := Format('%-20.20s',[FloatToStr(StrToFloat(Copy(sBarras_Temp, 1, 12)))]);
                            sProduto  := Format('%-20.20s',[IntToStr(dmMProvider.cdsSelProdExpPdvOP_PRODUTO.Value)]);
...
//                        sBarras   := Format('%-20.20s',[FormatFloat('00000000000000', StrToFloat(sBarras_Temp))]);
                  ...
                  sLinha := sProduto + sBarras + ' ' + '00000' + FormatFloat('0000000', dmMProvider.cdsSelProdExpPdvOP_QUANTIDADE.Value * 100);
...
var
  txtArq: TextFile;
  sLinha: string;
  sLog_CEST:TStringList;
begin

  sLog_CEST             := TStringList.Create;
  ...
  dmDBEXMaster.fdqSelProdExpPdv.Params[0].Value := iFilial;
  dmDBEXMaster.fdqSelProdExpPdv.Params[1].Value := pGeralAlterados;
  dmDBEXMaster.fdqSelProdExpPdv.Params[2].Value := pTipoCodigoIntegracao;
