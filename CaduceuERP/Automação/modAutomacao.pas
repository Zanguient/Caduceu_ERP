        ...
        begin
            ...
            case rdgTipoExpPdv.ItemIndex of
              ...
              1:begin
                  ...
                  if Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                    + 'Deseja liberar os produtos com status de alterados?'), 'Atenção!', mb_IconQuestion + mb_YesNo) = idYes then
                  begin
                    ...
                    try
                      ...
                      Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                                            + 'Operação realizada com sucesso!'), 'Atenção!', mb_IconInformation + mb_Ok);
                    except
                      Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                                            + 'Ouve falha na liberação!'), 'Atenção!', mb_IconWarning + mb_Ok);
                    end;
          ...
          begin
            ...
            Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                                  ...
                                  + 'Opção em desenvolvimento!'), 'Atenção!', mb_IconWarning + mb_Ok);
    ...
    3:begin //Zeus front end
        ...
        begin
          ...
          Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
            ...
            + ' não foi importado.' + #13 + #13
            + 'Para realizar o estorno'
            + 'é necessário que se realize uma importação!'),
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              //tipo de coleta informações / lidos do ecf ante da redução
...
{                  //tipo de coleta informações / lidos do ecf ante da redução
                ...
                begin
                  ...
                  Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                    + 'Não foi/foram encontrado(s) registros de movimento para a data selecionad:  ' + FormatDateTime('dd/mm/yyyy',dtpMovimentoImportacao.Date) + #13
                    ...
                    + 'Verifique se a redução Z foi emitida!'), 'Atenção!', mb_IconWarning + mb_Ok);
          ...
          begin
            ...
            if Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
              + 'A leitura do arquivo foi concluída.'+#13
              + 'Deseja gravar as informações no banco de dados?'),
            ...
            begin
              ...
              lblMsgProgresso.Caption := 'Aguarde..estornando registro 60 mestre - SINTEGRA' + #13 +
                                        'Estornando registro 60 analítico - SINTEGRA';
              ...
              lblMsgProgresso.Caption := 'Aguarde..estornando movimento de venda..' + #13
                                        ...
                                        +'Estornando registros sintegra: 60 diário, item, e mensal';
              lblMsgProgresso.Visible := true;
              ...
              Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                + 'Estatísticas atualizadas com sucesso!'), 'Atenção!', mb_IconInformation + mb_Ok);
    ...
    4:begin
        ...
        begin
          ...
          begin
            ...
            begin
              Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                + 'Não foi/foram encontrado(s) registros de movimento para a data selecionada:  ' + FormatDateTime('dd/mm/yyyy',dtpMovimentoImportacao.Date) + #13
                + 'referente ao ECF: ' + IntToStr(dmMProvider.cdsConfigECFNUMERO_CAIXA.Value) + '/' + dmMProvider.cdsConfigECFNUMERO_SERIE_ECF.Value +#13 +#13
                + 'Verifique se a redução Z foi emitida!'), 'Atenção!', mb_IconWarning + mb_Ok);
...
begin
  ...
  try
    ...
    { TODO 1 -olindomar -cimplementação : mudar importação para acesso direto ao banco }
    lblNumCx.Caption        := '';
      ...
      3:begin //Zeus Front End
          ...
          begin
            ...
            Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
              ...
              + 'Para realizar outra importação será necessário efetuar o estorno!'), 'Atenção!', mb_IconWarning + mb_Ok);
            ...
            begin
              ...
              begin
                ...
                lblMsgProgresso.Caption := 'Aguarde..gerando registro 60 mestre - SINTEGRA' + #13 +
                                           'Registro 60 analítico - SINTEGRA';
                ...
                lblMsgProgresso.Caption := 'Aguarde..gerando movimento de venda..' + #13
                                          ...
                                          +'Registros sintegra: 60 diário, item, e mensal';
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      memLogProdutos.Lines.Add('Código de barras não encontrado: ' + dmMProvider.fdmImpCupomBARRAS.Value);
              ...
              begin
                ...
                Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                  + 'Verifique o log de importação de produtos!'),
              ...
              case dmMProvider.cdsConfig_financeiroIMPORTAR_CHEQUES_PDV.AsInteger of
                1:begin
                    ...
                    begin
                      ...
                      lblMsgProgresso.Caption := 'Aguarde..efetuando lançamentos' + #13
                                               + 'de cheques a receber..';
                      lblMsgProgresso.Visible := true;
                      Application.ProcessMessages;
                      ...
                      begin
                        ...
                        begin
                          ...
                          begin
                            ...
                            memLogCheques.Lines.Add('Banco não cadastrado: ' + IntToStr(dmMProvider.fdmImpChequeBANCO.Value));
              ...
              begin
                ...
                lblMsgProgresso.Caption := 'Aguarde..atualizando informações pedido..!';
                lblMsgProgresso.Visible := true;
                pgbProgressoImportacao.Position := 0;
                Application.ProcessMessages;
              ...
              lblMsgProgresso.Caption := 'Aguarde..atualizando estatísticas finaceira..!';
              lblMsgProgresso.Visible := true;
              pgbProgressoImportacao.Position := 0;
              Application.ProcessMessages;
              ...
              begin
                ...
                Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario +#13 + #13
                  + 'Verifique o log de importação de cheques!'), 'Atenção!', mb_IconInformation + mb_Ok);
...
//              dmMProvider.cdsConfigECF.Next;
            ...
            begin
              ...
              begin
                ...
                if dmMProvider.cdsFilialUTILIZA_NFCE.Value = 0 then
                  lblMsgProgresso.Caption := lblMsgProgresso.Caption +'Registros sintegra: 60 diário, item, e mensal';
...
begin
  ...
  case dmMProvider.cdsConfiguracoesMODELOPDV.AsInteger of
    3:begin //Zeus Front End
        ...
        chkArquivosExportacao.AddItem('Preço por quantidade',chkArquivosExportacao);
...
begin
  ...
  case dmMProvider.cdsConfiguracoesMODELOBALANCA.AsInteger of
    6:begin //tolefo mgv5
        ...
        pnlSoftwareBalanca.Caption := 'MGV 5 - Módulo Gerenciador de Venda';
    ...
    9:begin //filizola smart
        ...
        pnlSoftwareBalanca.Caption := 'Smart Editor - Gerenciamento de Balanças';
