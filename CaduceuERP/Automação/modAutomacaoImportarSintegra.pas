        ...
        begin
          ...
          begin
            ...
            begin
              ...
              dmMProvider.fdmImpCupomVALOR_UNITARIO.Value     := StrToFloatDef(Copy(sLinha,70,13),1) / 100;
              dmMProvider.fdmImpCupomSUB_TOTAL.Value          := (dmMProvider.fdmImpCupomVALOR_UNITARIO.Value * dmMProvider.fdmImpCupomQUANTIDADE.Value);
