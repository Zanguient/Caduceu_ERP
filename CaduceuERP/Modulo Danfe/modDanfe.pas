  ...
  try
    ...
    begin
      ...
      begin
        ...
        CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
        Man_Tab_LOG_SYS(Application.Title,'O usuário usou opção para adicionar protocolo a nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Value),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
        Man_Tab_LOG_SYS(Application.Title,'O usuário selecionou a opção para cancelar a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
        ...
        begin
          ...
          CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
          Man_Tab_LOG_SYS(Application.Title,'O usuário cancelou a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
          ...
          dmMSProcedure.fdspMovimento.Params[0].Value     := 2;                                           //opção incluir estorno de movimento
{

          criar tratamento de estono na tabela de movimento

          dmMSProcedure.fdspMovimento.Params[0].Value     := 3;                                           //opção incluir estorno de movimento
          ...
          begin
            ...
            begin
              ...
              CC.Add('Esta mensagem refere-se ao cancelamento da Nota Fiscal Eletrônica de venda N°: ' +
              ...
              CC.Add(' ');
              CC.Add(' ');
              CC.Add('* Este e-mail foi enviado automaticamente pelo Sistema de Gestão GenesisAC-2010 ');
            ...
            begin
              ...
              lblMsg.Caption := 'Email inválido: ' +  dmMProvider.cdsClientesEMAIL.Value;
              Application.ProcessMessages;
          ...
          begin
            ...
            lblMsg.Caption := 'Email não configurado para o cliente: ' +  dmMProvider.cdsClientesRAZAOSOCIAL.Value;
            Application.ProcessMessages;
...
begin
  ...
  try
    ...
    begin
      ...
      OpenDialog1.Title       := 'Selecione a NFE para Carta de Correção - CCe';
      OpenDialog1.DefaultExt  := '*-nfe.XML';
      OpenDialog1.FilterIndex := 1;
      OpenDialog1.Filter      := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
      OpenDialog1.InitialDir  := ACBrNFe1.Configuracoes.Arquivos.PathNFe;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
                  Man_Tab_LOG_SYS(Application.Title,'O usuário criou a carta de correção para a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.nNF),frmCCe.memTextoCorrecao.Text,sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
                  ...
                  CC.Add('Esta mensagem refere-se à Carta de Correção referente a Nota Fiscal Eletrônica N°: ' +
                      InttoStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF) + ' emitida pela empresa:');
...
//                  lblMsg.Caption := 'Carta de correção rejeitada. Motivo: ' + RetornarRejeicao EventoRetorno.retEvento.Items[0].RetInfEvento.xMotivo;
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário usou opção para concultar o cadastro do cnpj/cpj: ' +  FormatarCNPJCPF(sDocumento),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    if (InputQuery('Consultar Recibo Lote', 'Número do Recibo', aux)) then
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário usou opção para de consulta lote: ' + aux,'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário selecionou a opção para conultar a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          CC.Add('Esta mensagem refere-se à Nota Fiscal Eletrônica de venda N°: ' +
              InttoStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF)+ ' emitida pela empresa:');
          ...
          if dmMProvider.cdsConfiguracoesENVIAR_XML_CONTABILIDADE.Value = 1 then
            lblMsg.Caption := 'Aguarde...enviando e-mail para: ' +  dmMProvider.cdsClientesEMAIL.AsString + #13
                              + ' com cópia para: ' + cEmailContabilidade[0]
          else
          ...
          CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
          Man_Tab_LOG_SYS(Application.Title,'O usuário enviou a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF) + ' por email','',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
      ...
      begin
        ...
        lblMsg.Caption := 'Email não configurado para o cliente: ' +  dmMProvider.cdsClientesRAZAOSOCIAL.AsString;
        Application.ProcessMessages;
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário gerou o pdf para a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.nNF),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário selecionou a opção para imprimir a nota: ' + IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Ide.cNF),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário usou opção para inutilizar a numeração de nota entre: ' + FormatFloat('000000000',iNumeroInicial) + ' e ' + FormatFloat('000000000',iNumeroFinal),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
      ...
      begin
        ...
        begin
          ...
          dmMSProcedure.fdspMan_Tab_RC100_SPED.Params[1].Value  := 1; //saída
...
begin
  ...
  try
    ...
    begin
      ...
      CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
      Man_Tab_LOG_SYS(Application.Title,'O usuário acionou a opção para selecionar notas para envio','',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);

    end
    else
    begin

      lblMsg.Caption  := dmDBEXMaster.sNomeUsuario +  ', não foi possível localizar a logomarca. Verifique as configurações';
      imgErro.Visible := True;
      Application.ProcessMessages;
...
begin
  ...
  try
    ...
    begin
      ...
      lblmsg.Caption   := dmDBEXMaster.sNomeUsuario +  MSG_AGUARDE + 'verificando status do serviço';
      Application.ProcessMessages;
...
begin
  ...
  try
    ...
    memStatusWSNfe.Lines.Add('Versão Aplic: ' + ACBrNFe1.WebServices.StatusServico.verAplic);
    ...
    memStatusWSNfe.Lines.Add('Observação:   ' + ACBrNFe1.WebServices.StatusServico.xObs);
...
begin
  ...
  begin
    ...
    CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
    Man_Tab_LOG_SYS(Application.Title,'O usuário confirmou o envio da nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Value),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
  ...
  begin
    ...
    CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
    Man_Tab_LOG_SYS(Application.Title,'O usuário cancelou o envio da nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Value),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    begin
      ...
      //verifica se a versão da nfe é 3.10 ou inferior
...
//            if (dmMProvider.cdsNFSaidaCONSUMIDOR_FINAL.Value = 1) and (not bDevolucao) then
  ...
  //              clEnq     := '999';
    ...
    begin
      ...
      Man_Tab_LOG_SYS(Application.Title,'O usuário acionou a opção visualizar a nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Value),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);

    end
    else
    begin

      Man_Tab_LOG_SYS(Application.Title,'O usuário acionou a opção enviar a nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Index),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  {
    ...
    futuramente será utilizado bpl
...
begin
  ...
  CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
  Man_Tab_LOG_SYS(Application.Title,'O usuário encerrou o módulo de ' + Application.Title,'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  try
    ...
    CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
    Man_Tab_LOG_SYS(Application.Title,'O usuário acionou a opção verificar status do serviço (WS)','',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
...
begin
  ...
  try
    ...
    CapturaTelaJpg(sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg');
    Man_Tab_LOG_SYS(Application.Title,'O usuário acionou a opção para enviar a nota: ' + IntToStr(dmMProvider.cdsNFSaidaNFSAIDA.Value),'',sPasta_Imagem_Log + NomeArquivo_sem_extensao(Application.ExeName) + '.jpg',3);
