...
type
  ...
  TfrmCCe = class(TForm)
    ...
    procedure memTextoCorrecaoEnter(Sender: TObject);
    procedure memTextoCorrecaoKeyPress(Sender: TObject; var Key: Char);
...
procedure TfrmCCe.FormActivate(Sender: TObject);
begin
...
procedure TfrmCCe.memTextoCorrecaoEnter(Sender: TObject);
begin
...
procedure TfrmCCe.memTextoCorrecaoKeyPress(Sender: TObject; var Key: Char);
begin
