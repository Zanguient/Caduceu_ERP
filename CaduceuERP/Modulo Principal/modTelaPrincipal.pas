...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Alíquotas de ICMS');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Bancos');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Cheques Pré-datados');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Cheques a Receber');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Contas Corrente');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Contas a Pagar');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Contas a Receber');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Estados');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Emissão de Etiquetas');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Formas de Pagamento');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Grupos de Produtos');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Informação Nutricional');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Integração de lojas');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Inventário');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Tipo de Lançamento');
...
{  if FileExists(ExtractFilePath(Application.ExeName)+'MREcf.exe') then
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Mapa Resumo de ECF');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de NBM / NCM');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Notas Fiscais de Entrada');
...
{      if not ValidarPermissao(Ord(pNFModelo02),dmDBEXMaster.iIdUsuario,'C') then
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Nota Fiscal modelo 02');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Ordem de Compra');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de permissões de usuários');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção do Plano de Contas');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de preços');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de itens Ficha Técnica / ingredientes receitas');
...
begin
  ...
  if Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario + ', deseja utilizar novo gerador de relatórios?'),
  ...
  begin
    ...
    begin
      ...
      Hwnd := FindWindow('TApplication', 'Relatórios');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Rentabilidade Animal');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Saldo de Produtos');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Seções');
...
{      if not ValidarPermissao(Ord(pServico),dmDBEXMaster.iIdUsuario,'C') then
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Cadastro de serviços');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Setor de Balança');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Sintegra - Sistema Integrado de informações');
    if Hwnd = 0 then
    begin
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de SubGrupos');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Suporte através de chat on-line');
...
{  if FileExists(ExtractFilePath(Application.ExeName)+'MComissao.exe') then
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de comissão de funcionários');
...
{    if dmDBEXMaster.sNomeUsuario <> 'SYSDBA' then
    ...
    Hwnd := FindWindow('TApplication', 'Apuração - ICMS');
...
{    if dmDBEXMaster.sNomeUsuario <> 'SYSDBA' then
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de CST/CSOSN-Cód. da Sit. Trib./Cód. de Sit. da Oper. no S. Nacional');
...
begin
  ...
  {      if not ValidarPermissao(Ord(pCidade),dmDBEXMaster.iIdUsuario,'C') then
      ...
      Hwnd := FindWindow('TApplication', 'Manutenção de Danfe');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Países');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Cadastro de promoção');
...
begin
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção do Regitro 60 mestre e analítico');
...
begin
 {
  ...
  begin
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de códigos similares');
...
{      if not ValidarPermissao(Ord(pInventario),dmDBEXMaster.iIdUsuario,'C') then
    ...
    Hwnd := FindWindow('TApplication', 'Manutenção de Situações - OS');
...
begin
  ...
  Caption                                 := Application.Title + ' / ' + dmDBEXMaster.sIP_Servidor + ' * CÓPIA REGISTRADA PARA: ' + dmMProvider.cdsFilialRAZAOSOCIAL.Value + ' * ';
...

 {
  ...
  definir cadastro de botões de módulo mais utilizados para o menu prinicpal
...
begin
  ...
  Application.MessageBox(pchar(dmDBEXMaster.sNomeUsuario
    + ', módulo em desenvolvimento!' + #13 + #13
    + 'Avisaremos quando concluído'),'Atenção!', mb_IconWarning +mb_Ok);
...
begin
  ...
  Application.MessageBox(pchar(dmDBEXMaster.sNomeUsuario
    + ', o sistema não está configurado para utilizar este módulo!' + #13 + #13
    + 'Entre em contato com o suporte técnico para esclarecer' + #13
    + 'qualquer dúvida!'),'Atenção!', mb_IconWarning +mb_Ok);
...
begin
  ...
  begin
    ...
    begin
      ...
      Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario + ', ' + MSG_ATUALIZACAO_DISP), 'Atenção!', MB_ICONINFORMATION + mb_Ok);
