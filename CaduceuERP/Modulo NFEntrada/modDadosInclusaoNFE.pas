{ DONE 1 -oLindomar -cchecagem :Falta validar codigodo ibge na cidade}
...
begin
  ...
  begin
    ...
    begin
      ...
      if dmDBEXMaster.VerificarCodigoIBGE(dmDBEXMaster.fdqFornecedor.FieldByName('CIDADE').Value,0) then
      begin
      ...
      begin
        ...
        lblMsg.Caption  := dmDBEXMaster.sNomeUsuario + MSG_CONFIG_CODIGO_IBGE_CIDADE + ' - ' + dmDBEXMaster.fdqFornecedor.FieldByName('NOME_CIDADE').Value;
        Application.ProcessMessages;
        ModalResult     := mrNone;
