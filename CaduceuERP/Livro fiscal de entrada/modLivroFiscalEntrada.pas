...
begin
  ...
  try
    ...
    if ExportarExcel(dmMProvider.cdsLivroFiscalEntrada,'Livro_Fiscal_Entrada.CSV',False,0) then
      Application.MessageBox(PChar(dmDBEXMaster.sNomeUsuario + ', arquivo: ' + ExtractFilePath(ParamStr(0)) + 'Livro_Fiscal_Entrada.CSV' + ' gerado com sucesso'), 'Informação!', MB_ICONINFORMATION + mb_Ok);
