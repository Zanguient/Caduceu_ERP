...
type
  TdmDBEXMaster = class(TDataModule)
    ...
    fdqSelecionaTabelaLOG: TFDQuery;
    fdqLogSys: TFDQuery;
  ...
  public
    ...
    dDataLicença, dDataHoraServidor:TDateTime;
...
uses uFuncoes, uConstantes_Padrao;
...
begin
  ...
  try
    ...
    fdcMaster.Params.Values['DATABASE'    ]   := ifArqConfig.ReadString('SERVIDOR','PATH',ExtractFilePath(Application.ExeName)+'BD\Caduceu.FDB');
...
begin
  ...
  case pOpcao of
    ...
    7:Result := 'WHERE NFSAIDA = -1'; // inclusão
  999:Result := 'WHERE NFSAIDA >= 4757'; // inclusão
  end
