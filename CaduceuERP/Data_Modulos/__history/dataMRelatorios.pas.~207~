...
begin
  ...
  case cdsListagemPedVendaTIPO.Value of
    0:cdsListagemPedVendaS_TIPO.Value := 'CARTÃO DE CRÉDITO';
    1:cdsListagemPedVendaS_TIPO.Value := 'CARTÃO DE DÉBITO';
    2:cdsListagemPedVendaS_TIPO.Value := 'CHEQUE';
    3:cdsListagemPedVendaS_TIPO.Value := 'CHEQUE-PAR';
    4:cdsListagemPedVendaS_TIPO.Value := 'CHEQUE-PRÉ';
    5:cdsListagemPedVendaS_TIPO.Value := 'CONTRA-VALE';
    6:cdsListagemPedVendaS_TIPO.Value := 'CONVÊNIO';
