object dmMDJPdv: TdmMDJPdv
  ...
  object fdmTemp_COFINS: TFDMemTable
    ...
    Left = 400
    Top = 294
    object fdmTemp_COFINSCST: TIntegerField
      FieldName = 'CST'
    end
  end
  object fdqCST_COFINS: TFDQuery
    Connection = dmDBEXMaster.fdcMaster
    SQL.Strings = (
      
        'select distinct cofins.*, pro.aliquota_cofins from cst_cofins co' +
        'fins'
      'join produto pro'
      'on(pro.cst_cofins = cofins.cst_cofins)')
    Left = 80
    Top = 294
  end
  object dspCST_COFINS: TDataSetProvider
    DataSet = fdqCST_COFINS
    Left = 198
    Top = 294
  end
  object cdsCST_COFINS: TClientDataSet
    ...
    object cdsCST_COFINSALIQUOTA_COFINS: TBCDField
