object frmSituacoesOS: TfrmSituacoesOS
  Left = 0
  Top = 0
  ...
  object pgcSituacoesOS: TPageControl
    Left = 8
    Top = 80
    Width = 703
    Height = 296
    ...
    object tbsTabela: TTabSheet
      ...
      object grdTabela: TDBGrid
        ...
        Cursor = crHandPoint
        Align = alClient
        DataSource = dmMSource.dtsSituacoes_OS
    ...
    object tdsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object chkAbertura_OS: TDBCheckBox
          Left = 138
          Top = 106
          Width = 97
          Height = 17
          Caption = 'Abertura da OS'
          DataField = 'ABERTURA_OS'
          DataSource = dmMSource.dtsSituacoes_OS
          TabOrder = 2
          ValueChecked = '1'
          ValueUnchecked = '0'
          OnClick = chkAbertura_OSClick
          OnKeyDown = edtConteudoPesquisaKeyDown
          OnKeyPress = edtConteudoPesquisaKeyPress
        end
        object chkOficina: TDBCheckBox
          Left = 138
          Top = 127
          Width = 280
          Height = 17
          Caption = 'Oficina / Manuten'#231#227'o- para opera'#231#245'es intermedi'#225'rias'
          DataField = 'OFICINA'
          DataSource = dmMSource.dtsSituacoes_OS
          TabOrder = 3
          ValueChecked = '1'
        ...
        object chkFechamento_OS: TDBCheckBox
          Left = 138
          Top = 149
          Width = 120
          Height = 17
          Caption = 'Fechamento da OS'
          DataField = 'FECHAMENTO_OS'
          DataSource = dmMSource.dtsSituacoes_OS
          TabOrder = 4
          ValueChecked = '1'
          ValueUnchecked = '0'
          OnClick = chkFechamento_OSClick
          OnKeyDown = edtConteudoPesquisaKeyDown
          OnKeyPress = edtConteudoPesquisaKeyPress
        end
        object chkPronto: TDBCheckBox
          Left = 486
          Top = 58
          Width = 122
          Height = 17
          Caption = 'Marcar como '#39'pronto'#39
          DataField = 'PRONTO'
          DataSource = dmMSource.dtsSituacoes_OS
          TabOrder = 5
          ValueChecked = '1'
        ...
        object chkCondicao_Fecham_OS: TDBCheckBox
          Left = 154
          Top = 172
          Width = 376
          Height = 17
          Caption = 'OS recusadas / n'#227'o realizadas (sem movimenta'#231#227'o financeira)'
          DataField = 'CONDICAO_FECHAMENTO_OS'
          DataSource = dmMSource.dtsSituacoes_OS
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
