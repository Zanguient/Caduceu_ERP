  ...
  object pgcFuncionario: TPageControl
    ...
    object tdsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object lblPercentualComissaoVenda: TLabel
          Left = 97
          Top = 320
          Width = 92
          Height = 13
        ...
        object edtPercentualComissaoVenda: TDBEdit
          Left = 193
          Top = 318
          Width = 80
          Height = 21
          DataField = 'PERCENTUAL_COMISSAO_VENDA'
          DataSource = dmMSource.dtsFuncionarios
          TabOrder = 17
          OnEnter = edtNomeEnter
          OnExit = edtNumeroExit
          OnKeyDown = edtCodigoKeyDown
          OnKeyPress = edtPercentualComissaoVendaKeyPress
        end
      end
    end
  end
