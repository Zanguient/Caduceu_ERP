object frmPerdas: TfrmPerdas
  ...
  object imgGreraRelatorioConsulta: TImage
    Left = 788
    Top = 348
    Width = 51
    Height = 44
  ...
  object pgcPerdas: TPageControl
    ...
    object tbsTabela: TTabSheet
      ...
      object grdTabela: TDBGrid
        ...
        Height = 409
        Align = alClient
        DataSource = dmMSource.dtsPerdas
    ...
    object tbsCadastro: TTabSheet
      ...
      object grpCadastro: TGroupBox
        ...
        object lblQuantidades: TLabel
          Left = 16
          Top = 93
          Width = 91
          Height = 13
          Caption = 'Quantidades totais'
        end
        ...
        object imgPesqFornecedor: TImage
          Left = 191
          Top = 42
          Width = 27
          Height = 22
          ...
          ShowHint = True
          Stretch = True
          OnClick = imgPesqFornecedorClick
        end
        ...
        object edtQuantidadesTotais: TDBEdit
          Left = 111
          Top = 90
          Width = 121
          Height = 21
        ...
        object grpItensPerdas: TGroupBox
          Left = 2
          Top = 136
          Width = 757
          Height = 108
          ...
          object rgpQuantidade: TGroupBox
            Left = 170
            Top = 19
            Width = 133
            Height = 41
          ...
          object grpCustoUnitario: TGroupBox
            Left = 305
            Top = 19
            Width = 185
            Height = 41
            ...
            TabOrder = 2
            object edtCustoUnitario: TJvValidateEdit
              Left = 93
              Top = 16
              Width = 89
              Height = 21
      ...
      object grpGradeItens: TGroupBox
        Left = 0
        Top = 247
        Width = 761
        Height = 162
        Align = alBottom
        TabOrder = 1
        object grdItensPerdas: TDBGrid
          Left = 2
          Top = 15
          Width = 757
          Height = 145
          Align = alClient
          DataSource = dmMSource.dtsItensPerdas
          DrawingStyle = gdsClassic
          Options = [dgTitles, dgIndicator, dgColLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit, dgTitleClick, dgTitleHotTrack]
          ReadOnly = True
          TabOrder = 0
          ...
          TitleFont.Name = 'Tahoma'
          TitleFont.Style = []
          OnDblClick = grdItensPerdasDblClick
          OnKeyDown = grdItensPerdasKeyDown
          OnKeyPress = grdItensPerdasKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'PRODUTO'
            ...
            item
              ...
              Title.Alignment = taCenter
              Title.Caption = 'CUSTO UNIT'#193'RIO'
              Width = 90
              Visible = True
            end
            item
  ...
  object ActionList1: TActionList
    ...
    object actExcluirItensPerdas: TAction
      Category = 'Window'
      Caption = 'actExcluirItensPerdas'
      OnExecute = actExcluirItensPerdasExecute
    end
