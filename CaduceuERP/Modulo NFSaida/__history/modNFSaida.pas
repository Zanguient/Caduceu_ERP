      ...
      begin
        ...
        begin
          ...
          begin
            ...
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                         := SimpleRoundTo((dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value - (dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaPERCENTUAL_REDUCAO.Value / 100))),-2);
          ...
          begin
            ...
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                         := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value - SimpleRoundTo(((dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaPERCENTUAL_REDUCAO.Value / 100))),-2);
            dmMProvider.cdsItemNFSaidaVALOR_ICMS.Value                        := SimpleRoundTo((dmMProvider.cdsItemNFSaidaBASE_ICMS.Value * (dmMProvider.cdsItemNFSaidaICMS.Value / 100)),-2);
        ...
        begin
          ...
          if dmMProvider.cdsPesqCFOPGERA_DEBITO_CREDITO_IPI.Value = 1 then
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                       := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value + dmMProvider.cdsItemNFSaidaVALOR_IPI.Value
          else
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                       := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value;
          dmMProvider.cdsItemNFSaidaVALOR_ICMS.Value                        := SimpleRoundTo((dmMProvider.cdsItemNFSaidaBASE_ICMS.Value * (dmMProvider.cdsItemNFSaidaICMS.Value / 100)),-2);
          dmMProvider.cdsItemNFSaidaISENTAS_NAO_TRIBUTADAS.Value            := 0;
