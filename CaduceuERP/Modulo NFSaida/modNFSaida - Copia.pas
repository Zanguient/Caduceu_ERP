...
//      dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value                         := Arredondar(dmMProvider.cdsItemNFSaidaVALORUNITARIO.AsFloat * dmMProvider.cdsItemNFSaidaQUANTIDADE.Value,2)
    ...
    dmMProvider.cdsItemNFSaidaVALOR_CARGA_NAC_FEDERAL.Value           := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaCARGA_NAC_FEDERAL.Value / 100);
    dmMProvider.cdsItemNFSaidaVALOR_CARGA_IMP_FEDERAL.Value           := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaCARGA_IMP_FEDERAL.Value / 100);
    dmMProvider.cdsItemNFSaidaVALOR_CARGA_ESTADUAL.Value              := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaCARGA_ESTADUAL.Value / 100);
    dmMProvider.cdsItemNFSaidaVALOR_CARGA_MUNICIPAL.Value             := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaCARGA_MUNICIPAL.Value / 100);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                         := SimpleRoundTo((dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value - (dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaPERCENTUAL_REDUCAO.Value / 100))),-2) - dmMProvider.cdsItemNFSaidaVALOR_DESCONTO.Value;
          ...
          begin
            ...
            dmMProvider.cdsItemNFSaidaBASE_ICMS.Value                         := dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value - SimpleRoundTo(((dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsItemNFSaidaPERCENTUAL_REDUCAO.Value / 100))),-2) - dmMProvider.cdsItemNFSaidaVALOR_DESCONTO.Value;
            dmMProvider.cdsItemNFSaidaVALOR_ICMS.Value                        := SimpleRoundTo((dmMProvider.cdsItemNFSaidaBASE_ICMS.Value * (dmMProvider.cdsItemNFSaidaICMS.Value / 100)),-2);
...
{          dmMProvider.cdsItemNFSaidaPERCENTUAL_REDUCAO.Value      := 0;
        ...
        //calcular ST
        if (dmMProvider.cdsPesqCFOPSUBSTITUICAO_TRIBUTARIA.Value = 1) and (dmMProvider.cdsPesqCFOPCFOP.Value[1] = '6') and (Copy(FormatFloat('000',dmMProvider.cdsItemNFSaidaCST.Value),2,2) = '10')  or (Copy(FormatFloat('000',dmMProvider.cdsItemNFSaidaCST.Value),2,2) = '60')  then
        begin
          ...
          begin
            ...
            begin
              ...
              dmMProvider.cdsItemNFSaidaBASE_SUBSTITUICAO.Value   := (dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value - dmMProvider.cdsItemNFSaidaVALOR_DESCONTO.Value) + SimpleRoundTo(((dmMProvider.cdsItemNFSaidaSUB_TOTAL.Value * (dmMProvider.cdsEstadosMVA.Value / 100))),-2);
...
{  if dmMProvider.cdsNFSaidaDESTINO_OPERACAO.Value = 3 then
